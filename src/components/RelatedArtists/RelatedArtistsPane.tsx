...
export const RelatedArtistsPane = () => {
    ...
    const createAllRequests = (artists: Artist[]) : string[] =>  {
        let requests = [];
        artists.forEach(a => {
            requests.push(`https://app.ticketmaster.com/discovery/v2/events?apikey=ZysF29VGfUq33IKG2ujdgB75x6BL3Gie&keyword=${a.name}&radius=200&unit=miles&locale=*&city=new%20york&countryCode=US`);
        });
        return requests;
    }
